...
function adicionaLinha() {
    linhas.push({ um: itemUm.textContent, dois: itemDois.textContent, tres: itemTres.textContent, });

    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    for (let i = 0; i < linhas.length; i++) {

        //poderia usar um array.every() no codigo abaixo?
        if (
...
function jogar() {
    if (itemUm.textContent == "" &&
        itemDois.textContent == "" &&
        itemTres.textContent == "" && linhas.length < 6) {
        let num1 = gerador();
        let num2 = gerador();
        let num3 = gerador();
        ...
        num1 % 2 ? moedaUm.src = "./img/coroa.png" : moedaUm.src = "./img/cara.png";
        num2 % 2 ? moedaDois.src = "./img/coroa.png" : moedaDois.src = "./img/cara.png";
        num3 % 2 ? moedaTres.src = "./img/coroa.png" : moedaTres.src = "./img/cara.png";
        adicionaLinha();
